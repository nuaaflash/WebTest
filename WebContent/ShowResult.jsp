<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="Sql.*" import="java.util.ArrayList"
	import="java.util.List"%>
<%@page import="org.lxh.smart.SmartUpload" import="Dataset.*"
	import="Algorithm.*" import="java.util.ArrayList"
	import="java.util.List"%>
...
<!-- CSS -->
<link href="white/css/bootstrap.min.css" rel="stylesheet"
	type="text/css" />
...
<link href="white/css/animate.css" rel="stylesheet" type="text/css"
	media="all" />
			...
			<div class="menu_block">
				...
				<div class="container clearfix">
					...
					<div class="logo pull-left">
						<a href="MainPage.jsp"><span class="b1">系统</span><span
							class="b2">效能</span><span class="b3">评估</span><span class="b4">软件</span><span
							class="b5">系统</span></a>
					</div>
					<!-- //LOGO -->
...
%>
								<p>
<%
									for(int j = 0; j<node.get(i).level; j++) {																					
%>
										&emsp; &emsp; 
<%
									}
%>
									<font color="#2B2B2B" size="5"><%=node.get(i).nodeName%>:
										<%=node.get(i).value%></font>
								</p>

								<div class="layui-progress layui-progress-big">
									<div class="layui-progress-bar layui-bg-cyan"
										lay-percent="<%=node.get(i).value%>%"></div>
								</div>
								<br>
								<br>
								<br>
